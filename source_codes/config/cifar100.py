config = {}
config['data_path'] = './datasets/cifar100'
...
config['exp_directory'] = 'experiment/cifar100_%s_%.1f'%(config['noise_mode'],config['noise_ratio'])
config['checkpoint_dir'] = 'experiment/cifar100_%s_%.1f'%(config['noise_mode'],config['noise_ratio'])
